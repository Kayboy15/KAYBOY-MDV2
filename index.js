 ...
 * @author : KAYBOY <https://github.com/kayboy154>
...
const ownerNumber = ['263779745277']
...
console.log("CONNECTING KAYBOY-MD🧬...");
...
console.log('KAYBOY-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ KAYBOY-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: https://files.catbox.moe/kt9yjh.jpg }, caption: up })
...
app.get("/", (req, res) => {
res.send("HEY, KAYBOY-MD STARTED ✅");
});
